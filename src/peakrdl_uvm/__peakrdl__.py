...
class Exporter(ExporterSubcommandPlugin):
    ...
    def add_exporter_arguments(self, arg_group: 'argparse.ArgumentParser') -> None:
        ...
        arg_group.add_argument(
            "--assume-regblock-paths",
            dest="assume_regblock_paths",
            default=False,
            action="store_true",
            help="Assume hdl_paths compatible with PeakRDL-regblock if not otherwise specified"
        )
    ...
    def do_export(self, top_node: 'AddrmapNode', options: 'argparse.Namespace') -> None:
        ...
        x.export(
            ...
            assume_regblock_paths=options.assume_regblock_paths,
        )
